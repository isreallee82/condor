        ...
        *,
        ...
        try:
            ...
            with (
                ...
                # The budget wraps the run *inside* the scope, so a cancelled
                # run is still attributed and still recorded — a breach must
                # land in the record below as a failure, not vanish.
                if timeout_sec:
